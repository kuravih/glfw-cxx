#ifndef _GLFW_CXX_INPUT_H_
#define _GLFW_CXX_INPUT_H_
...
namespace glfw
{
     ...
     *\warning Not all of these joysticks are plugged in. Please follow normal GLFW_CXX procedure as to checking whether a joystick is plugged in or not.
     */
    enum Joystick
    {
        Joystick1 = 0,
