#ifndef _GLFW_CXX_WINDOW_H_
#define _GLFW_CXX_WINDOW_H_
...
namespace glfw
{
    ...
    public:
        ...
        /*!\brief Sets the window's size limits
         * \param[in] minSize The window's minimum size
         * \param[in] maxSize The window's maximum size
         */
        void SetSizeLimits(WindowSize minSize, WindowSize maxSize);

        /*!\brief Sets the window's size limits
         * \param[in] minwidth the window's minimum width
         * \param[in] minheight the window's minimum height
         * \param[in] maxwidth the window's maximum width
         * \param[in] maxheight the window's maximum height
         */
         ...
         *
         *  This function sets an attribute of the window.
         *
         *  \param[in] attrib The [window attribute](\ref window_attribs) whose value to
         *  set.
         ...
         * \warning Do NOT use this function if you want to use GLFW_CXX's event queue.
         */
